        ...
        <div class="login_form shadow" align="center">
            <div class="login-form-right-side" style="font-size:15px">
                <div class="top-logo-wrap">
                    <img id="login-logo" src="@/assets/images/scmlogo.png">
                </div>
                <h3 class="banner">Supply Chain Management</h3>
                <p class="descript">NPM Vue SCM Toy Project</p>
            </div>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            checkCode:function(event){if(event.keyCode==13)this.fLoginProc()},
            fLoginProc:function(){
                ...
                if(this.isValidated()){
                    ...
                    this.axios
                        .post('/loginProc.do',new URLSearchParams({lgn_Id:this.lgn_Id,pwd:this.pwd}))
                        .then((resp)=>{
                            ...
                            if(data.result=="SUCCESS"){
                                ...
                                data.usrMnuAtrt.forEach(function (item) {
                                    ...
                                    item.nodeList.forEach(function (item) {
                                        ...
                                        console.log('  메뉴명: '+item.mnu_nm+' || 파일경로 : '+vueFilePath)   
