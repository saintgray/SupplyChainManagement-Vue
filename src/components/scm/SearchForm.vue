    ...
    <div class="searchArea" id="v-SearchArea">
        <div class="form-inline justify-content-around">
            <div class="form-group" id="keyword-group">
                <select id="searchKey" name="searchKey" class="form-control" v-model="searchType">
            ...
            <div class="form-group">
                <input type="text" id="keyword" class="form-control mx-sm-3" placeholder="검색어를 입력하세요" v-model="keyword" @keydown='search'>
            </div>
            <div class="form-group">
                <button type="button" class="btn btn-primary" id="searchBtn" @click='sendParams'>검색</button>
            </div>
        </div>
    </div>
