<template>
  <dl>
    ...
    <div class="btn_areaC mt30">
      ...
      <a @click="save()" class="btnType blue" id="btnSaveGrpCod" name="btn"
        ><span>저장</span></a
      >
      <a
        @click="deletefrpcd()"
...
export default {
  ...
  props: { title: String, grpcd: String, paction: String },
  data: function () {
    return {
      pgrpcd: this.grpcd,
      grp_cod: "",
  ...
  mounted: function () {
    alert(
      "Popup mount : " + this.pgrpcd + " : " + this.grpcd + " : " + this.action
    );
    let vm = this;
  ...
  methods: {
    ...
    save: function () {
      ...
      //alert("grp_cod : " + this.grp_cod + "pgrp_cod : " + this.pgrpcd);
